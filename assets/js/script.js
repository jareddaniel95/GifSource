...
var pastGiphyResponses = JSON.parse(localStorage.getItem("PastGiphyResponses"));
    if (pastGiphyResponses) {
        pastGiphyResponses.forEach(pastResponse => {
            ...
            historyItem.attr("style", `width: 200px; height: 200px; display: flex; background-image: url(${pastResponse.response}); background-repeat: no-repeat; background-size: 100% 100%;`);
            var historyName = $('<h2>');
